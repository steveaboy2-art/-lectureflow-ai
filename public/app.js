...
function renderSettings(){
  el('view-settings').innerHTML=`<div class="settings-list"><div class="settings-card"><h3>AI processing</h3><p>LectureFlow uses Gemini through secure Vercel Functions. No Gemini API key is stored in your browser.</p><div class="integration-row"><div class="integration-name"><div class="integration-icon">G</div><div><strong>Gemini 3.8 Flash</strong><small>Audio → transcript-grounded MBBS notes</small></div></div><button class="connection-pill" id="geminiInfo">Checking…</button></div><div class="integration-row"><div class="integration-name"><div class="integration-icon">V</div><div><strong>Vercel Functions</strong><small>Secure server-side Gemini access</small></div></div><span class="connection-pill connected">Connected</span></div></div>
