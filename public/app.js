...
function normalizeGeneratedLecture(result,meta){
  ...
  return {
    ...
    professor:arr(result?.professor), mustKnow:arr(result?.mustKnow), lectureOnlyNotes:arr(result?.lectureOnlyNotes), fullNotes:arr(result?.fullNotes),
...
function openLecture(id, initialTab='lecture'){
